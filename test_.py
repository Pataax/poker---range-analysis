...
class TestGeneralParametersCardSelectionWindow:
    ...
    def test_click_select_Ad_card_by_invoke(self, hero_csw):
        hero_csw.card_dict['Ad'].button.invoke() 

    def test_result_list_select_cards(self, hero_csw):
        assert hero_csw.selected_cards == ['Ad']

    def test_color_change_selected_card(self, hero_csw):
        assert hero_csw.card_dict['Ad'].button['bg'] == 'gray'

    def test_click_deselect_Ad_card_by_invoke(self, hero_csw):
        assert hero_csw.card_dict['Ad'].button.invoke() == ''
